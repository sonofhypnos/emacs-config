...
* Miscelanous
I copied this macro from [[https://stackoverflow.com/a/22418983/492140][here]] to get [[https://github.com/emacs-evil/evil-surround][vim-surround]] keybindings for these special characters: |/.*$.
#+begin_src emacs-lisp
...
#+RESULTS:
| er/add-org-mode-expansions | tassilo/enable-post-tangle | org-pdftools-setup-link | org-hide-properties | +lookup--init-org-mode-handlers-h | #[128 \300\301\302\303\304$\207 [add-hook before-save-hook org-encrypt-entries nil t] 6 |
