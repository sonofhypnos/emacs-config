...
* My Configuration
Inspired by [[https://leanpub.com/lit-config][Literate Configuration]] I decided to migrate to a literate configuration. As of now, this is still in the rough draft stage and not really readable.
...
#+end_src
* TODO Hook this to opening Emacs files
...
Remove todos from my literate config
#+begin_src emacs-lisp
